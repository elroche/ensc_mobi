...
const MovieScreen = ({ navigation }) => {
  ...
  const filterMoviesByGenre = (movies, genre) => {
    if (!genre) {
      // Si le genre n'est pas spécifié, retourne la liste complète de films
      return movies;
    }
    return movies.filter((movie) => {
      // Sinon, filtre la liste de films selon le genre sélectionné
  ...
  useEffect(
    () => {
      const unsubscribe = navigation.addListener("focus", () => {
        // Ajoute un listener qui réagit au focus de la page
